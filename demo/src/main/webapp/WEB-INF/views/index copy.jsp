          ...
          <section id="hero" class="hero">
            ...
            <div class="container">
              <div class="row search-book">
                <div class="col-lg-10">
                  <h2 data-aos="fade-up" data-aos-delay="100">Online Library</h2>
                  <p data-aos="fade-up" data-aos-delay="200">We are team of talented designers making websites</p>
                </div>
                <div class="col-lg-5">
                  <form action="#" class="sign-up-form d-flex" data-aos="fade-up" data-aos-delay="300">
                    <input type="text" class="form-control" placeholder="읽고 싶은 도서를 검색해보세요.">
                    <input type="image" src="assets/img/search-icon.png" width="70px" class="" value="">
                  </form>
                </div>
              </div>
            </div>
